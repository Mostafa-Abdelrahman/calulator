namespace calculator_moustafaaaa
{
    public partial class Form1 : Form
    {
        ...
        private void Equal_Click(object sender, EventArgs e)
        {
            ...
            {
                case "+":
                     num1 = Convert.ToDouble(input_one.Text);
                     num2 = Convert.ToDouble(input_two.Text);
                    result.Text = (num1 + num1).ToString();
                    break;
                case "*":
                     num1 = Convert.ToDouble(input_one.Text);
                     num2 = Convert.ToDouble(input_two.Text);
        ...
        private void input_box_Enter(object sender, EventArgs e)
        {
